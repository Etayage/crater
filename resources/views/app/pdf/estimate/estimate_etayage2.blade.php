...
<head>
    <title>{!! $company->name !!}, @lang('pdf_estimate_label')</title>
    ...
    <style type="text/css">
        ...
        .address-container {
            ...
            margin-top: 10px;
            border-top:3px solid #0E2F45;
            border-bottom:3px solid #0E2F45;
        }
            ...
            <tr>
                @if ($logo)
                    <td width="60%" class="header-section-left">
                        <a href='https://www.etayage.fr' target="_blank"><img class="header-logo" style="height: 50px;" src="{{ $company->getMedia('logo_alt')->first()->getFullUrl() }}" alt="Company Logo"></a>
                    </td>
                @else
                ...
                <td width="40%" class="header-section-right estimate-details-container">
                    <h1>{!! $titre !!}</h1>
                    <h4>@lang('pdf_estimate_label') {{ $estimate->estimate_number }}</h4>
    ...
    <div class="content-wrapper">
        <div class="address-container">
            ...
            <div class="billing-address-container billing-address" style="float:right; margin-right:30px;">
                <div style="float:right;">
                    ...
                    <b>{!! $estimate->customer->contact_name !!}</b><br/>
                    {!! $estimate->customer->billingAddress()->get()[0]->address_street_1 !!}<br/>
                    {!! $estimate->customer->billingAddress()->get()[0]->zip  !!} {!! $estimate->customer->billingAddress()->get()[0]->city  !!}<br/>
        ...
        <div class="notes">
            @if ($notes)
                ...
                <b>Valable jusqu'au :</b> {!! $estimate->formattedExpiryDate !!}<br/><br/>
                {!! $notes !!}
            @endif
        </div>
        ...
        <div class="signature">
            ...
            Si vous êtes d'accord sur le devis, 
            merci de le renvoyer signé précédé de la date manuscrite et mention "bon pour accord" à 
